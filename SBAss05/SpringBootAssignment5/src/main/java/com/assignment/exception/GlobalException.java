...
public class GlobalException {
	...
	public ResponseEntity<ErrorDetails> GlobalExceptionHandler(RuntimeException rx, WebRequest web){
		ErrorDetails ed = new ErrorDetails(new Date(), rx.getMessage(), web.getDescription(false));
